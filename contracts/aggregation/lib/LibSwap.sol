...
library LibSwap {
    ...
    function swap(bytes32 transactionId, SwapData memory _swap) internal {
        ...
        uint256 nativeValue = LibAsset._isNative(_swap.sendingAssetId) ? _swap.fromAmount : 0;
        ...
        if (nativeValue == 0) {
            LibAsset._maxApproveERC20(IERC20(_swap.sendingAssetId), _swap.approveTo, _swap.fromAmount);
        }
